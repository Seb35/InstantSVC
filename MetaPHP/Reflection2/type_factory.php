...
/**
 * File containing the iscReflectionTypeFactoryImpl class.
 *
 * @package Reflection
 * @version //autogentag//
 ...
 */
class iscReflectionTypeFactoryImpl implements ezcReflectionTypeFactory {
    ...
    public function getType($typeName) {
        ...
        //else it has to be a user class
            ...
            //return new iscReflectionClassType($typeName);
            return new iscReflectionClass($typeName);
        }
    }
    ...
    public static function getMethodObject($class, $name) {
    	...
    	return self::$methodCache[$methodKey];
    }
}

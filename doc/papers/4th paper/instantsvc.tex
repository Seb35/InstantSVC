...
\usepackage{graphicx}
\usepackage[
	pdftitle={Web Services with eZ Components: A Design Proposal},
	pdfauthor={Falko Menge, Stefan Marr},
	pdfsubject={Web Services},
	pdfkeywords={Web Services,PHP5,eZ Components, SOAP, WSDL, ReST, WS-Security, Username Token Profile},
...
\hyphenation{ezc-Re-flec-tion-Pro-per-ty}
...
Requirements and design are specified for each component.
\end{abstract}
...
platforms and programming languages and they are therefore a
...
ezcReflectionAnnotationReturn and
...
Furthermore the CodeAnalyzer should collect statistics
...
The only pieces of information in a WSDL file that are new
...
between sender and receiver as shown in figure \ref{fig:SOAP-Intermediaries}.

\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{figures/SOAP-Intermediaries.eps}
	\caption{SOAP Intermediaries}
	\label{fig:SOAP-Intermediaries}
\end{figure}
...
Basically it works like a front controller for SOAP
...
as described by Roy Thomas Fielding \cite{ReST}.
...
\begin{figure}[htbp]
	...
	\caption{FMC block diagram \cite{FMC} of the Web Service component}
...
for using new dynamic programming techniques like aspect-oriented 
...
\emph{Web Services Description Language (WSDL) 1.1}, W3C Note \hskip 1em plus
  ...
  \newline \url{http://www.w3.org/TR/wsdl}
...
Architecture 1.0} \hskip 1em plus
  ...
  \newline \href{http://www.oasis-open.org/committees/download.php/19679/soa-rm-cs.pdf}{\texttt{http://www.oasis-open.org/committees/download.php/19679/soa-rm-}}
  \newline \href{http://www.oasis-open.org/committees/download.php/19679/soa-rm-cs.pdf}{\texttt{cs.pdf}}

\bibitem{InstantSVC}
\emph{InstantSVC - The PHP Web Services Builder}
  \newline \url{http://instantsvc.sourceforge.net}

\bibitem{phpDocumentor}
\emph{phpDocumentor: The complete documentation solution for PHP}
  \newline \url{http://phpdoc.org}

\bibitem{XDoclet}
\emph{XDoclet: Attribute-Oriented Programming for Java}
  \newline \url{http://xdoclet.sourceforge.net/}
...
\emph{Web Services Description Language (WSDL) 2.0}, W3C Candidate Recommendation \hskip 1em plus
  ...
  \newline \url{http://www.w3.org/TR/wsdl20}
...
\emph{Basic Profile Version 1.2} \hskip 1em plus
  ...
  \newline \url{http://www.ws-i.org/Profiles/BasicProfile-1.2.html}
  
\bibitem{PHP5Reflection}
\emph{PHP Manual: Reflection}
  \newline \url{http://www.php.net/manual/en/language.oop5.reflection.php}

\bibitem{SwA}
\emph{SOAP Messages with Attachments} \hskip 1em plus
  0.5em minus 0.4em\relax World Wide Web Consortium (W3C), December 11, 2000.
  \newline \url{http://www.w3.org/TR/SOAP-attachments}

\bibitem{WSS}
\emph{Web Services Security: SOAP Message Security 1.1} \hskip 1em plus
  0.5em minus 0.4em\relax OASIS Standard Specification, February 1, 2006.
  \newline \href{http://www.oasis-open.org/committees/download.php/16790/wss-v1.1-spec-os-SOAPMessageSecurity.pdf}{\texttt{http://www.oasis-open.org/committees/download.php/16790/wss-v1.}}
  \newline \href{http://www.oasis-open.org/committees/download.php/16790/wss-v1.1-spec-os-SOAPMessageSecurity.pdf}{\texttt{1-spec-os-SOAPMessageSecurity.pdf}}
  
\bibitem{UTP}
\emph{Web Services Security UsernameToken Profile 1.1} \hskip 1em plus
  0.5em minus 0.4em\relax OASIS Standard Specification, February 1, 2006.
  \newline \href{http://www.oasis-open.org/committees/download.php/16782/wss-v1.1-spec-os-UsernameTokenProfile.pdf}{\texttt{http://www.oasis-open.org/committees/download.php/16782/wss-v1.}}
  \newline \href{http://www.oasis-open.org/committees/download.php/16782/wss-v1.1-spec-os-UsernameTokenProfile.pdf}{\texttt{1-spec-os-UsernameTokenProfile.pdf}}
...
Fielding, Roy Thomas. \emph{Architectural Styles and the Design of Network-based Software Architectures.} \hskip 1em plus
  ...
  \newline \url{http://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm}

\bibitem{RFC2617}
\emph{RFC 2617: HTTP Authentication: Basic and Digest Access Authentication} \hskip 1em plus
  0.5em minus 0.4em\relax Network Working Group, June 1999.
  \newline \url{http://tools.ietf.org/html/rfc2617}
...
\emph{Extensible Markup Language (XML) 1.1 (Second Edition)}, W3C Recommendation \hskip 1em plus
  ...
  \newline \url{http://www.w3.org/TR/xml11/}
  
\bibitem{FMC}
\emph{Fundamental Modeling Concepts}
  \newline \url{http://www.fmc-modeling.org/}

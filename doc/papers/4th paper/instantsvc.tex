%TODO: Web Services => web services
...
%------------------
\paragraph{iscCodeAnalyzerClassLoader}
...
seperately using one of the summarization methods
...
This class provides methods to recursivly load 
php files from a given directory.

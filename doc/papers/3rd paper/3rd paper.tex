...
\begin{abstract}
Dieses Paper beschreibt die Ergebnisse unserer Arbeit an einer Familie von Werkzeugen für Web Services unter PHP5. Die besonderen Spracheigenschaften machen die Entwicklung von Meta-Spach-Werkzeugen etwas schwierig. Daher wurde zunächst die Reflection API erweitert um die benötigten Informationen über Sprachkonstrukte zu bekommen. Auf dieser Basis wurde zunächst ein leistungsfähiger WSDL-Generator...
\end{abstract}
...
Dabei wird besonders auf die Architektur und die getroffenen Design-Entscheidungen eingegangen, die zu der jeweiligen Lösung geführt haben.

...
\begin{itemize}
  \item \emph{PasswortText (Standardwert)}
...
bietet seit der Version 5 eine Implementierung des SOAP-Protokolls, welche es
erlaubt Web Services zu erstellen, beziehungsweise angebotene Dienste zu nutzen.
Sicherheitsmechanismen sind in diesem Erweiterungsmodul allerdings noch nicht integriert.
Die Umsetzung des Username Token Profiles für PHP wird auf Basis der
vorhandenen Klassen SoapClient und SoapServer erfolgen. Dies hat den
Vorteil, dass das Abarbeiten von SOAP-Nachrichten nicht nochmal
neu implementiert werden muss. Im Idealfall profitiert die erstellte Lösung auch
von zukünftigen Verbesserungen des SOAP-Erweiterungsmoduls. Die Extension selbst ist in C
geschriebenen und bietet somit einen klaren Geschwindigkeitsvorteil gegenüber anderen
SOAP-Implementierungen, die direkt in PHP geschrieben sind. Die erstellten PHP Klassen erben von diesen bzw.
...
knappen Dokumentation der SOAP-Erweiterung, welche ein Review des SourceCodes unerlässlich
...
Das Thema SoapFaults basiert ebenfalls auf dem Web Services Security Standard

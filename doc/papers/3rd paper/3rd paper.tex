...
Als erstes wird, wie schon oft beschrieben, der SOAP-Header ausgelesen und die
...
\begin{enumerate}
	...
	erzeugt und die Anfrage an den Web Service weitergeleitet wird, sofern
...
Dieser Parser löscht den gesamten SOAP-Header. Demnach nutzt er die
...
wird, sondern gleich der gesamte SOAP-Header. Dieser Parser sollte demnach als
allerletztes an den \texttt{ExtendedSoapServer} übergeben werden.

\subsubsection{SOAP-Faults}
\label{wss:SoapFaults}
Das Thema SOAP-Faults basiert ebenfalls auf dem Web Services Security Standard
...
dem PHP eigenen SOAP-Server abgeleitet werden konnte. Es ist daher eher eine
...
SOAP-Header. Die Benutzung der Klasse ist dabei idealerweise nahezu identisch zum
SoapClient und unterscheidet sich lediglich im erweiterten Konstruktor.

Die Erstellung des SOAP-Headers ist unter PHP allerdings eine Sache für sich. Es
